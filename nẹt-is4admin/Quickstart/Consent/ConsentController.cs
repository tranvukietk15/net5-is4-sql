...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class ConsentController : Controller
    {
        ...
        private async Task<ProcessConsentResult> ProcessConsent(ConsentInputModel model)
        {
            ...
            var requestScopes = request.ValidatedResources.RawScopeValues; // TODO check
            ...
            else if (model?.Button == "yes")
            {
                ...
                if (model.ScopesConsented != null && model.ScopesConsented.Any())
                {
                    ...
                    // emit event
                    await _events.RaiseAsync(new ConsentGrantedEvent(User.GetSubjectId(), request.Client.ClientId, requestScopes, grantedConsent.ScopesValuesConsented, grantedConsent.RememberConsent));
                }
                else
                {
